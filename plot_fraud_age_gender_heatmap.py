...
if __name__ == '__main__':
    ...
    parser.add_option("--input_data_path", dest="input_data_path", default="../data", help="input datapath",
                      metavar="FILE")
    parser.add_option("--attn_data_path", dest="attn_data_path", default="results/Fraud/fraud_age_gender_non_smote_weighted_class_correct_attn/attn_scores.npy", help="attn datapath",
                      metavar="FILE")
    ...
    parser.add_option("--save_path", dest="save_path", default="../saved_ckpt", help="save checkpoint path",
                      metavar="FILE")
    parser.add_option("--result_dir", dest="result_dir", default="results/fraud_detect_age_gender_non_smote_class_weight_real_attn_single_layer/", help="save result path", metavar="FILE")
    ...
    fig.tight_layout()
    plt.savefig('plot/fraud_age_gender_heat_map.png', dpi=600)
    plt.show()
    #
