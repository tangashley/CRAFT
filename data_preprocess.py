...
def preprocess(save_folder):
    ...
    scale_features = ['BILL_AMT1', 'BILL_AMT2', 'BILL_AMT3', 'BILL_AMT4',
    ...
    for feature in scale_features:
        temp = df[feature].apply(lambda x: round(x / 20000))
...
if __name__ == '__main__':
    save_folder = "data/UCI/feature_prefix_bin_stride_20000_limit_bal"
